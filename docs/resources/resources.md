...
[詳細はこちら](/docs/resources/seeeduino-storage-for-flashair){: .btn .btn-blue }
...
[詳細はこちら](/docs/resources/airioplay){: .btn .btn-blue }
[購入](/docs/resources/airioplay/#purchase){: .btn .btn-green }

### Airio RP（えありおあーるぴー）

FlashAirを用いてプロトタイプ開発を行うためのボードです。DIP形状／SPI-I2Cブリッジ IC／リセットスイッチ・リセット端子／LEDピン

[詳細はこちら](/docs/resources/airiorp){: .btn .btn-blue }
[購入](/docs/resources/airiorp/#purchase){: .btn .btn-green }

### Airio（えありお）

FlashAir評価ボードです。FlashAirのGPIO機能を使用して、ブラウザからフルカラーLEDを駆動したり、スイッチの値を取得することなどが可能です。

[詳細はこちら](/docs/resources/airio){: .btn .btn-blue }
[購入](/docs/resources/airio/#purchase){: .btn .btn-green }
...
[詳細はこちら](/docs/resources/dipio){: .btn .btn-blue }
[購入](/docs/resources/dipio/#purchase){: .btn .btn-green }

### Arduino

製品プロトタイピングなどの用途でとても人気のあるマイコンボードです。ユーザーがクローンを製造したり、改造して独自のArduino互換ボードを作ることが容易です。

[詳細はこちら](/docs/tutorials/arduino/1){: .btn .btn-blue }
