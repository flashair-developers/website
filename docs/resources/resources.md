...
[詳細はこちら](/docs/resources/seeeduino-storage-for-flashair.html){: .btn .btn-blue }
...
[詳細はこちら](/docs/resources/airioplay.html){: .btn .btn-blue }
[購入](/docs/resources/airioplay.html/#purchase){: .btn .btn-green }

### Airio RP（えありおあーるぴー）

FlashAirを用いてプロトタイプ開発を行うためのボードです。DIP形状／SPI-I2Cブリッジ IC／リセットスイッチ・リセット端子／LEDピン

[詳細はこちら](/docs/resources/airiorp.html){: .btn .btn-blue }
[購入](/docs/resources/airiorp.html/#purchase){: .btn .btn-green }

### Airio（えありお）

FlashAir評価ボードです。FlashAirのGPIO機能を使用して、ブラウザからフルカラーLEDを駆動したり、スイッチの値を取得することなどが可能です。

[詳細はこちら](/docs/resources/airio.html){: .btn .btn-blue }
[購入](/docs/resources/airio.html/#purchase){: .btn .btn-green }
...
[詳細はこちら](/docs/resources/dipio.html){: .btn .btn-blue }
[購入](/docs/resources/dipio.html/#purchase){: .btn .btn-green }

### Arduino

製品プロトタイピングなどの用途でとても人気のあるマイコンボードです。ユーザーがクローンを製造したり、改造して独自のArduino互換ボードを作ることが容易です。

[詳細はこちら](/docs/tutorials/arduino/1.html){: .btn .btn-blue }
...
ARM Cortex-A RZ/A1LU搭載のリファレンスボードで、Mbed開発環境およびRenesasWebコンパイラ、IDE for GRでの開発が可能です。
