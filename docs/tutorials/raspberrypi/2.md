...
(処理詳細は[iSDIO_WLAN_SendHTTPMessageByRegister](../../api/isdio/reference/upload/#sendhttpmessagebyregister)を参照)
...
(処理詳細は[iSDIO_WLAN_SendHTTPFileByRegister](../../api/isdio/reference/upload/#sendhttpfilebyregister)を参照)
...
(処理詳細は[iSDIO_WLAN_SendHTTPSSLMessageByRegister](../../api/isdio/reference/upload/#sendhttpsslmessagebyregister)を参照)
...
(処理詳細は[iSDIO_WLAN_SendHTTPSSLFileByRegister](../../api/isdio/reference/upload/#sendhttpsslfilebyregister)を参照)
...
(処理詳細は[iSDIO_WLAN_SendHTTPMessageByFile](../../api/isdio/reference/upload/#sendhttpmessagebyfile)を参照)
...
(処理詳細は[iSDIO_WLAN_SendHTTPFileByFile](../../api/isdio/reference/upload/#SendHTTPFileByFile)を参照)
...
(処理詳細は[iSDIO_WLAN_SendHTTPSSLMessageByFile](../../api/isdio/reference/upload/#SendHTTPSSLMessageByFile)を参照)
...
(処理詳細は[iSDIO_WLAN_SendHTTPSSLFileByFile](../../api/isdio/reference/upload/#SendHTTPSSLFileByFile)を参照)
